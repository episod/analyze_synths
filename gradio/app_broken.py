...
def analyze_single_audio_file(
    ...
    Returns:
        Tuple of (analysis_text, download_file_path, visualization_path)
    """
    ...
    try:
        ...
        progress(0.2, desc="Initializing audio analyzer...")
...
def create_interface():
    ...
    with gr.Blocks(
        ...
        with gr.Tab("Audio Analysis"):
            ...
            def update_analysis(audio_file, analysis_type, export_format):
                result_text, download_path, viz_path = analyze_single_audio_file(
                    audio_file, analysis_type, export_format
                )
